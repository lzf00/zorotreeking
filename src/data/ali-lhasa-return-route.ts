...
replaceCopiedDrivingDay("10.04", {
  ...
  overnight: "尚客优品酒店（班戈店）；10.04 改住班戈，把纳木措留给次日上午。已锁的纳木错富氧需改期或取消。",
...
export const aliLhasaReturnDailyPlanning: AliRouteDailyPlanning[] = [
  ...
  },
  {
    ...
    reservations: [
      {
        ...
        note: "色林措是 10 月 4 日唯一景观目标，当晚住班戈，不再赶纳木措。只使用 G317 及正规开放观景点，不进入草场、湿地和湖滩。没有可靠预约入口时，不从非官方渠道购买所谓通行名额。",
    ...
    stay: {
      city: "班戈县城",
      budget: standardRoomBudget,
      bookingAdvice: `${nationalDayHotelAdvice} 10.04 改住班戈，把纳木措留给 10 月 5 日上午。已锁的纳木错富氧需改期或取消；改期失败才继续东进，10.05 会重新变短。`,
      hotels: [
        {
          name: "尚客优品酒店（班戈店）",
          strengths: "10.04 改住这里，拆开改则到拉萨的车程；订前确认供氧、停车和晚到保留。",
          bookingUrl: "https://hotels.ctrip.com/hotels/129496888.html",
        },
        {
          name: "班戈县城其他供氧宾馆",
          strengths: "尚客优品无法入住时同城电话确认，不继续赶纳木措过夜。",
          bookingUrl: "https://www.amap.com/search?query=%E7%8F%AD%E6%88%88%E4%BE%9B%E6%B0%A7%E9%85%92%E5%BA%97",
        },
      ],
    },
  },
