...
export const travelGuides: TravelGuide[] = [
  ...
  },
  {
    ...
    description: "9 月 26 日拉萨取车，9 月 29 日住巴松顺康富氧看珠峰日落星空，全员 10 月 2 日到狮泉河，G317 经改则、色林措，10 月 4 日住纳木错富氧，5 日晨看纳木措后回拉萨。",
    date: "2026-09-16",
    updated: "2026-09-18",
    location: "西藏 · 阿里大环线",
    days: 12,
    ...
    season: "2026 国庆",
    route: ["拉萨", "日喀则", "定日", "珠峰", "萨嘎", "塔钦", "札达", "狮泉河", "改则", "色林措", "纳木措", "拉萨", "上海"],
    destination: "lhasa",
    destinationLabel: "拉萨",
    scope: "complete",
    scopeLabel: "完整行程",
